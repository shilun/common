...
import org.springframework.data.redis.core.StringRedisTemplate;public class JedisLock implements DistributedLock{
     ...
     * @param lockKey 锁的键值
     */
    public JedisLock(String lockKey,RedisTemplate redisTemplate) {
     ...
     */
    public JedisLock(String lockKey, int timeoutMsecs,RedisTemplate redisTemplate) {
        this.lockKey = lockKey;
     ...
     */
    public JedisLock(String lockKey, int timeoutMsecs, int expireMsecs,RedisTemplate redisTemplate) {
        this.lockKey = lockKey;
        this.timeoutMsecs = timeoutMsecs;
