...
import com.common.webservice.ServerDataProvider;
...
public class AuthDateHeader extends AbstractSoapInterceptor {
    ...
    private String getContent() {
        return DESEncryptUtils.encrypt(this.key + "_" + DateUtil.format(this.serverDataProvider.buildServerData()), this.key);
    }
    ...
    public void setServerDataProvider(ServerDataProvider serverDataProvider) {
